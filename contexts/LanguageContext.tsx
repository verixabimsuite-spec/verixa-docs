...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'matrix.col.free': 'Free Trial (7 Days)',
  ...
  id: {
    ...
    'matrix.col.free': 'Uji Coba Gratis (7 Hari)',
